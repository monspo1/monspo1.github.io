...
function drawChartWithSeriesData(){
	...
	pArray = parsedArray;	
	status('info', 'total ' + pArray.length + ' rows retrieved');		// <-- no problem...
	
	/*
	status('info', 'total ' 
		   + filteredForArrForChemo.length + filteredForArrForChemoRad.length 
		   + filteredForArrForHormonal.length + filteredForArrForRadiation.length
		   + filteredForArrForSurgery.length + filteredForArrForSurgRad.length
		   + filteredForArrForNoTreatment.length
		   + ' rows retrieved');
	*/
		...
		*/
		chart.addSeries({
			...
			data: [
				...
				{x: -0.2, median: medianForChemo, category: "Chemo"}, {x: 0.3, median: medianForChemo, category: null},
				{x: 0.8, median: medianForChemoRad, category: "Chemo"}, {x: 1.3, median: medianForChemoRad, category: null},
				{x: 1.8, median: medianForHormonal, category: "Chemo"}, {x: 2.3, median: medianForHormonal, category: null},
				{x: 2.8, median: medianForRadiation, category: "Chemo"}, {x: 3.3, median: medianForRadiation, category: null},
				{x: 3.8, median: medianForSurgery, category: "Chemo"}, {x: 4.3, median: medianForSurgery, category: null},
				{x: 4.8, median: medianForSurgRad, category: "Chemo"}, {x: 5.3, median: medianForSurgRad, category: null},
				{x: 5.8, median: medianForNoTreatment, category: "Chemo"}, {x: 6.3, median: medianForNoTreatment, category: null}
	...
	*/
	...
	for(i=0;i<seerdata.length;i++){
		...
		*/
		...
		if(anemia == "no"){ anemia = ""; } else{ anemia = "YES"; }
		if(bowelDys == "no"){ bowelDys = ""; } else{ bowelDys = "YES"; }
		if(decLibido == "no"){ decLibido = ""; } else{ decLibido = "YES"; }
		if(erectileDys == "no"){ erectileDys = ""; } else{ erectileDys = "YES"; }
		if(fatigue == "no"){ fatigue = ""; } else{ fatigue = "YES"; }
		if(hotFlash == "no"){ hotFlash = ""; } else{ hotFlash = "YES"; }
		if(nV == "no"){ nV = ""; } else{ nV = "YES"; }
		if(urinaryDys == "no"){ urinaryDys = ""; } else{ urinaryDys = "YES"; }
		if(weightLoss == "no"){ weightLoss = ""; } else{ weightLoss = "YES"; }
					...
					data: 
						(function() {
							...
							*/
							...
							/*
							var varForSideEffectUrinaryDys = "";
							var varForSideEffectBowelDys = "";
							var varForSideEffectHotFlash = "";
							var varForSideEffectDecLibido = "";
							var varForSideEffectNauVomit = "";
							var varForSideEffectWeiLoss = "";
							var varForSideEffectFatigue = "";
							var varForSideEffectAnemia = "";
							var varForSideEffectErecDys = "";
							*/
							for (i = 0; i <= filteredForArrForChemo.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForChemo[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForChemo[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForChemo[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForChemo[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForChemo[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForChemo[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForChemo[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForChemo[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForChemo[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
								
								data.push({
									x: 0 + (Math.random() * 50 + 30)/100 - 0.5,
									y: filteredForArrForChemo[i].survivalMonths,
									anemia: varForSideEffectAnemia, 
									bowelDys: varForSideEffectBowelDys, 
									chemo: filteredForArrForChemo[i].chemo, 
									chemoRad: filteredForArrForChemo[i].chemoRad, 
									decLibido: varForSideEffectDecLibido,
									disease: filteredForArrForChemo[i].disease, 
									dxAge: filteredForArrForChemo[i].dxAge, 
									dxGrade: filteredForArrForChemo[i].dxGrade, 
									dxYear: filteredForArrForChemo[i].dxYear, 
									erectileDys: varForSideEffectErecDys,
									fatigue: varForSideEffectFatigue, 
									hormonal: filteredForArrForChemo[i].hormonal, 
									hotFlash: varForSideEffectHotFlash, 
									isAlive: filteredForArrForChemo[i].isAlive, 
									nV: varForSideEffectNauVomit, 
									noTreatment: filteredForArrForChemo[i].noTreatment, 
									race: filteredForArrForChemo[i].race, 
									radiation: filteredForArrForChemo[i].radiation, 
									surgRad: filteredForArrForChemo[i].surgRad, 
									surgery: filteredForArrForChemo[i].surgery, 
									treatmentOption: filteredForArrForChemo[i].treatmentOption, 	
									urinaryDys:  varForSideEffectUrinaryDys, 
									weightLoss: varForSideEffectWeiLoss
									//y: Math.random() * 10 + 5
								});
								//*/
					...
					data: (function() {
							...
							*/
							...
							for (i = 0; i <= filteredForArrForChemoRad.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForChemoRad[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForChemoRad[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForChemoRad[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForChemoRad[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForChemoRad[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForChemoRad[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForChemoRad[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForChemoRad[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForChemoRad[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
						...
						(function() {
							...
							*/
							...
							for (i = 0; i <= filteredForArrForHormonal.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForHormonal[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForHormonal[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForHormonal[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForHormonal[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForHormonal[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForHormonal[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForHormonal[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForHormonal[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForHormonal[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
						...
						(function() {
							...
							*/
							...
							for (i = 0; i <= filteredForArrForRadiation.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForRadiation[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForRadiation[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForRadiation[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForRadiation[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForRadiation[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForRadiation[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForRadiation[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForRadiation[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForRadiation[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
						...
						(function() {
							...
							*/
							...
							for (i = 0; i <= filteredForArrForSurgery.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForSurgery[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForSurgery[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForSurgery[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForSurgery[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForSurgery[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForSurgery[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForSurgery[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForSurgery[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForSurgery[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
						...
						(function() {
							...
							*/
							...
							for (i = 0; i <= filteredForArrForSurgRad.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForSurgRad[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForSurgRad[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForSurgRad[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForSurgRad[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForSurgRad[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForSurgRad[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForSurgRad[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForSurgRad[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForSurgRad[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
						...
						(function() {
							...
							*/
							...
							for (i = 0; i <= filteredForArrForNoTreatment.length - 1; i++) {
								...
								//*/
								/*
								if(filteredForArrForNoTreatment[i].anemia == "yes"){
									varForSideEffectAnemia = "YES";
								} else{
									varForSideEffectAnemia = "";	
								}
								
								if(filteredForArrForNoTreatment[i].bowelDys == "yes"){
									varForSideEffectBowelDys = "YES";
								} else{
									varForSideEffectBowelDys = "";	
								}
								
								if(filteredForArrForNoTreatment[i].decLibido == "yes"){
									varForSideEffectDecLibido = "YES";	
								} else{
									varForSideEffectDecLibido = "";	
								}
								
								if(filteredForArrForNoTreatment[i].erectileDys == "yes"){
									varForSideEffectErecDys = "YES";
								} else{
									varForSideEffectErecDys = "";	
								}
								
								if(filteredForArrForNoTreatment[i].fatigue == "yes"){
									varForSideEffectFatigue = "YES";
								} else{
									varForSideEffectFatigue = "";	
								}
								
								if(filteredForArrForNoTreatment[i].hotFlash == "yes"){
									varForSideEffectHotFlash = "YES";
								} else{
									varForSideEffectHotFlash = "";
								}
								
								if(filteredForArrForNoTreatment[i].nV == "yes"){
									varForSideEffectNauVomit = "YES";	
								} else{
									varForSideEffectNauVomit = "";	
								}
								
								if(filteredForArrForNoTreatment[i].urinaryDys == "yes"){
									varForSideEffectUrinaryDys = "YES";
								} else{
									varForSideEffectUrinaryDys = "";
								}
								
								if(filteredForArrForNoTreatment[i].weightLoss == "yes"){
									varForSideEffectWeiLoss = "YES";
								} else{
									varForSideEffectWeiLoss = "";	
								}
