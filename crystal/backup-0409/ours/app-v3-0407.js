	...
	chart.addSeries({
		...
		data: (function() {
			...
			for (i = 0; i < filteredArrForSideEffect2.length; i++) {
				...
				if(filteredArrForSideEffect2[i].treatmentOption == "Chemo"){
					tempData.push({
						x: 0 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
				...
				} else if(filteredArrForSideEffect2[i].treatmentOption == "Chemo+Rad"){
					tempData.push({
						x: 1 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
				...
				} else if(filteredArrForSideEffect2[i].treatmentOption == "Hormonal"){
					tempData.push({
						x: 2 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
				...
				} else if(filteredArrForSideEffect2[i].treatmentOption == "Radiation"){
					tempData.push({
						x: 3 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
					});
				} else if(filteredArrForSideEffect2[i].treatmentOption == "Surgery"){
					tempData.push({
						x: 4 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
				...
				} else if(filteredArrForSideEffect2[i].treatmentOption == "Surg+Rad"){
					tempData.push({
						x: 5 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
				...
				} else if(filteredArrForSideEffect2[i].treatmentOption == "No-Treatment"){
					tempData.push({
						x: 6 + (Math.random() * 50 + 30)/100 - 0.5,
						//x: filteredArrForSideEffect[i].x,
						y: filteredArrForSideEffect2[i].survivalMonths
